...
function my_google_font() {
	...
	<link href='http://fonts.googleapis.com/css?family=Aclonica:400,700' rel='stylesheet' type='text/css'>
...
function twentythirteen_holi_custom_header_setup() {
	...
	$args = array(
		...
		'default-image'          => '%2$s/images/headers/' . $color_scheme . '/bambooHeader2013.png',
	...
	foreach ( $holi_colors as $holi_color_value => $holi_color_name ) :
		$new_headers[$holi_color_value . '-circle'] = array(
			'url'           => '%2$s/images/headers/' . $holi_color_value . '/bambooHeader2013.png',
			'thumbnail_url' => '%2$s/images/headers/' . $holi_color_value . '/bamboo-thumbnail.png',
